...
class EventCfg:
    ...
    robot_joint_stiffness_and_damping = EventTerm(
        ...
        params={
            ...
            "stiffness_distribution_params": (1.125, 1.125),
            "damping_distribution_params": (1.65, 1.65),
            "operation": "scale",
    ...
    robot_joint_limits = EventTerm(
        ...
        params={
            "asset_cfg": SceneEntityCfg("robot", joint_names=".*"),
            "lower_limit_distribution_params": (0.00, 0.00),
            "upper_limit_distribution_params": (0.00, 0.00),
            "operation": "add",
...
@configclass
class SH1EnvCfg(DirectRLEnvCfg):
    # env
    decimation = 2
...
@configclass
class SH1OpenAIEnvCfg(SH1EnvCfg):
    # env
    decimation = 3
